...
CREATE INDEX idx_byok_sessions_team_round ON byok_sessions(team_id, round_session_id);
CREATE INDEX idx_byok_sessions_expires ON byok_sessions(expires_at) WHERE is_validated = true;
CREATE INDEX idx_byok_usage_logs_team ON byok_usage_logs(team_id, created_at DESC);
CREATE INDEX idx_byok_usage_logs_challenge ON byok_usage_logs(challenge_id, created_at DESC);
CREATE INDEX idx_byok_rate_limits_team_challenge ON byok_rate_limits(team_id, challenge_id);
