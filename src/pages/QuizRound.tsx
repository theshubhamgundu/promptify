    ...
    <div className="min-h-screen bg-gray-50 flex flex-row relative">
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex-shrink-0 flex flex-col">
        ...
        <div className="p-4 border-t border-gray-200 flex-shrink-0 space-y-2">
          ...
          <button onClick={() => navigate && navigate('dashboard')} className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition-colors">
            Exit
          </button>
        </div>
      </div>
