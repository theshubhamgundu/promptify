...
export default function Round4Engine({ roundId, navigate }: Round4EngineProps) {
  ...
  if (isLoading || !roundSession || !currentTeam) {
    return (
      <div className="min-h-screen w-full bg-[#f9f7f4] flex flex-col items-center justify-center p-6 space-y-4">
  ...
  if (isRoundFinished) {
    return (
      <div className="min-h-screen w-full bg-[#f9f7f4] overflow-y-auto p-6 sm:p-10 flex flex-col items-center justify-center">
        <div className="p-8 max-w-3xl w-full mx-auto space-y-8 animate-fade-in">
  ...
  return (
    <div className="min-h-full w-full bg-[#f9f7f4] p-4 sm:p-6 lg:p-8">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-2 -ml-1 text-gray-400 hover:text-gray-700 hover:bg-gray-100 rounded-xl transition-colors"
